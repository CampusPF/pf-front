/* Generado con scripts/gen-countries.mjs — nombres en español (Intl),
...
export const COUNTRIES: Country[] = [
  ...
  { code: "BQ", name: "Caribe neerlandés", dialCode: "599", flag: "🇧🇶" },
  ...
  { code: "AX", name: "Islas Aland", dialCode: "358", flag: "🇦🇽" },
  ...
  { code: "VI", name: "Islas Vírgenes de EE. UU.", dialCode: "1340", flag: "🇻🇮" },
  ...
  { code: "HK", name: "RAE de Hong Kong (China)", dialCode: "852", flag: "🇭🇰" },
  { code: "MO", name: "RAE de Macao (China)", dialCode: "853", flag: "🇲🇴" },
  ...
  { code: "PS", name: "Territorios Palestinos", dialCode: "970", flag: "🇵🇸" },
